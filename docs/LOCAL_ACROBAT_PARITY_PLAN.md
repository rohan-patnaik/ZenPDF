...
| L012 | Full-document text search | M1 / Reader | Text adapter | Partial | Generated three-page text/result-activation regression exists; Unicode/no-text/malformed/hostile/long-document/cancellation/highlight/AT tests missing | Tagged, untagged, and independent-producer corpus missing |
