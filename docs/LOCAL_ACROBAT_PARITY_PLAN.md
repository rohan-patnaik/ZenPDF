...
| L012 | Full-document text search | M1 / Reader | Text adapter | Partial | Generated regressions cover text/result activation, Unicode, blank and malformed PDFs, query supersession, active-search destruction, and an 80-page fixture; hostile/very-large resource limits, true cancellation/timeout, highlight fidelity, installed AT, and independent-producer tests remain | Tagged, untagged, and independent-producer corpus missing |
